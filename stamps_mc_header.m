function stamps_mc_header_upd(start_step,end_step,patches_flag,est_gamma_parm,patch_list_file)
...
%
% 09/2018 Alex Apostolakis - Electrical and Computer engineer - NTUA, MSc - National Observatory of Athens
%         nohup needed to run matlab on Linux-Unix
%         matlab looses STAMPS path when running this way so you need to add it again
